...
export function Swap({ navigation }) {
    ...
    return (
        <SafeArea>
            <View style={{ flex: 1, backgroundColor: "#1f2423" }}>
                <View style={styles.contanier}>
                     <TouchableOpacity>
                    <Image source={require('../assets/aave1.png')} style={{height:32,width:32,borderRadius:8}}
                    />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity onPress={() => setmodalOpen(true)}>
                        <View style={{
                            flexDirection: "row", alignItems: "center", backgroundColor: "#17b3ab",
                            justifyContent: "center", borderRadius: 5, padding: 8,
                        }}>
                            <Text style={{ fontSize: 16, marginRight: 9, color: "#f7fcfc" }}>Connect wallet</Text>
                    ...
                    <View style={styles.contanier2}>
                            ...
                            <View style={styles.swapBox2}>
                                ...
                                <TouchableOpacity onPress={visibility2}>
                                    <View style={styles.selectCoin}>
                                        ...
                                        <Text style={{ fontWeight: "bold", fontSize: 18, marginHorizontal: 5, color: "black",textTransform: "uppercase" }}>
                                            {selectedCoin2.symbol == "" ? "Select token" : selectedCoin2.symbol}
                                        </Text>
                                        <FontAwesomeIcon icon={faAngleDown} size={15} color="black" style={{ marginHorizontal: 5 }} />
                                    </View>
                                </TouchableOpacity>
                            </View>
                            :
                        ...
                        <TouchableOpacity onPress={() => setmodalOpen(true)}>
                            <View style={styles.swap3}>
                                <Text style={{ color: "#f7fcfc", fontSize: 21, fontWeight: '600' }}>Connect Wallet</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <View style={styles.SetWallet2}>
                                        <View style={styles.SetWalletLogo2}>
                                            <Image source={require('../assets/cont3.png')} style={{ height: 40, width: 40,borderRadius:30 }} />
                                            <Text style={{ marginLeft: 10,fontSize: 20,fontWeight:"500",margin:5 }}>Wallet Connect</Text>
                                        </View>
                                    </View>
                                </TouchableOpacity>
                                <View style={{padding:10}}>
                                    <Text style={{ fontSize: 18, fontWeight: '400' }}>By connecting a wallet, you agree to Aave and consent to its</Text>
                                    <TouchableOpacity onPress={() => navigation.navigate('Info')}>
                                        <Text style={{ color: 'red', fontSize: 18, fontWeight: '400' }}>Terms of Service and Privacy Policy </Text>
                                    </TouchableOpacity>
