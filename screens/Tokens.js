...
export function Tokens({ navigation }) {
    ...
    return (
        <SafeArea>
            <View style={{ flex: 1, backgroundColor: "#c2cccb" }}>
                <View style={styles.contanier}>
                    <TouchableOpacity onPress={() => navigation.navigate("Swap")}>
                    <Image source={require('../assets/aave1.png')} style={{ height: 32,width:32,}}
                    />
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity onPress={() => setmodalOpen(true)}>
                        <View style={{
                            flexDirection: "row", alignItems: "center", backgroundColor: "#f7fcfc",
                            justifyContent: "center", borderRadius: 10, padding: 8,
                        }}>
                            <Text style={{ fontSize: 16, marginRight: 9, color: "black" }}>Connect wallet</Text>
                ...
                <View style={{ padding: 10 }}>
                    <Text style={{ fontSize: 35, marginTop: 5 }}>Top Tokens</Text>
                    <Text style={{ fontSize: 35, }}>Listed</Text>
                    ...
                    <View style={styles.TokensName}>
                        ...
                        <View style={styles.modalView}>
                            ...
                            <View style={styles.modercontent2}>
                                ...
                                <View style={{padding:10}}>
                                    <Text style={{ fontSize: 18, fontWeight: '400' }}>By connecting a wallet, you agree to Aave's and consent to its</Text>
                                    
                                    <TouchableOpacity onPress={() => navigation.navigate('Info')}>
                                        <Text style={{ color: 'red', fontSize: 18, fontWeight: '500' }}>Terms of Service and Privacy Policy</Text>
                                    </TouchableOpacity>
